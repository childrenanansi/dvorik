(function (f) {
  if (typeof exports === 'object' && typeof module !==
    'undefined') {module.exports = f();} else if (typeof define === 'function' &&
    define.amd) {define([], f);} else {
    var g;
    ...
    1: [
      ...
      function (require, module, exports) {
        ...
        function getCookie(cookieName, cookieString) {
          ...
          if (cookieString && cookieString !== '') {
            ...
            for (var i = 0; i < cookies.length; i++) {
              ...
              if (cookie.substring(0, cookieName.length + 1) ===
                cookieName + '=') {
        ...
        var SessionAuthentication = function () {
          function SessionAuthentication() {
            ...
            this.csrfToken = getCookie(options.csrfCookieName,
          ...
          _createClass(TokenAuthentication, [
            {
              key: 'authenticate',
              value: function authenticate(options) {
                options.headers['Authorization'] = this.scheme + ' ' +
                  this.token;
                return options;
              },
            }]);
        ...
        function lookupLink(node, keys) {
          ...
          try {
            for (var _iterator = keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if (node === undefined) {
                throw new errors.LinkLookupError('Invalid link lookup: ' +
                  JSON.stringify(keys));
              }
            }
          } catch (err) {
          ...
          _createClass(Client, [
            {
              ...
              value: function action(document, keys) {
                ...
                var transport = utils.determineTransport(this.transports,
                  link.url);
        ...
        function primitiveToNode(data, baseUrl) {
          ...
          if (isObject && data._type === 'document') {
            ...
            for (var idx = 0, len = fieldsData.length; idx < len; idx++) {
              ...
              var field = new document.Field(name, required, location,
                fieldDescription);
              fields.push(field);
            }
            return new document.Link(_url, method, 'application/json', fields,
              _title, _description);
          } else if (isObject) {
            // Object
            var _content = {};
      ...
      function (require, module, exports) {
        ...
        var Link = function Link(url, method) {
          var encoding = arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : 'application/json';
          var fields = arguments.length > 3 && arguments[3] !== undefined
            ? arguments[3]
            : [];
        ...
        var Field = function Field(name) {
          ...
          var location = arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : '';
          var description = arguments.length > 3 && arguments[3] !== undefined
            ? arguments[3]
            : '';
          ...
          function ParameterError(message) {
            ...
            var _this = _possibleConstructorReturn(this,
              (ParameterError.__proto__ ||
                Object.getPrototypeOf(ParameterError)).call(this, message));
          ...
          function LinkLookupError(message) {
            ...
            var _this2 = _possibleConstructorReturn(this,
              (LinkLookupError.__proto__ ||
                Object.getPrototypeOf(LinkLookupError)).call(this, message));
          ...
          function ErrorMessage(message, content) {
            ...
            var _this3 = _possibleConstructorReturn(this,
              (ErrorMessage.__proto__ ||
                Object.getPrototypeOf(ErrorMessage)).call(this, message));
      ...
      function (require, module, exports) {
        ...
        var parseResponse = function parseResponse(
          response, decoders, responseCallback) {
              ...
              value: function buildRequest(link, decoders) {
                ...
                for (var idx = 0, len = fields.length; idx < len; idx++) {
                  ...
                  if (!params.hasOwnProperty(field.name)) {
                    if (field.required) {
                      throw new errors.ParameterError('Missing required field: "' +
                        field.name + '"');
                    } else {
                      continue;
                    }
                ...
                for (var property in params) {
                  if (params.hasOwnProperty(property) &&
                    ...
                    throw new errors.ParameterError('Unknown parameter: "' +
                      property + '"');
                  }
                }
      ...
      function (require, module, exports) {
        ...
        var negotiateDecoder = function negotiateDecoder(
          ...
          throw Error('Unsupported media in Content-Type header: ' +
            contentType);
        };
      ...
      function (require, module, exports) {
        ...
        URL.prototype.set = function set(part, value, fn) {
          ...
          switch (part) {
            ...
            case 'pathname':
              url.pathname = value.length && value.charAt(0) !== '/' ? '/' +
                value : value;
        ...
        URL.prototype.toString = function toString(stringify) {
          if (!stringify ||
            'function' !== typeof stringify) stringify = qs.stringify;
          ...
          if (protocol &&
            protocol.charAt(protocol.length - 1) !== ':') protocol += ':';
...
//
      ...
      }, {'./lolcation': 20, 'querystringify': 17, 'requires-port': 18}], 20: [
      function (require, module, exports) {
        (function (global) {
          'use strict';
          ...
          UrlTemplate.prototype.getValues = function (
            ...
            if (this.isDefined(value) && value !== '') {
              if (typeof value === 'string' || typeof value === 'number' ||
                ...
                result.push(this.encodeValue(operator, value,
                    ...
                    if (expression) {
                      ...
                      expression.split(/,/g).forEach(function (variable) {
                        ...
                        values.push.apply(values,
                          that.getValues(context, operator, tmp[1], tmp[2] ||
                            tmp[3]));
                      });
